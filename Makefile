...
all:
	./catttl.rb textbook textbook-rc textbook-rc-bib curriculum curriculum-versions catalogue subject subjectArea subjectType school publisher schema shape > all-`date +%Y%m%d`.ttl
