function get_nhk4school(cscode, page = 1) {
  ...
  .catch(function (error) {
      ...
      render_nhk4school_results("<p>Load failed.</p>", cscode, page, false);
  });
  ...
  function render_nhk4school(data, cscode) {
      ...
      if (data['error'] || !data['counts']) {
          ...
          html += `<p>Videos by NHK for School: Showing ${pageStart} - ${pageEnd} of ${data['counts']} results:</p>`;
          //コンテンツ一覧を表示
          html += `<div class="row">`;
                  ...
                  <div class="col-md-4">
                    <div class="card shadow-sm">
                      ...
                      <div class="card-body small">
                        ...
                        <button type="button" class="btn btn-outline-light"><a href="${data['result'][i]['url']}">View</a></button>
                      </div>
                    </div>
                  </div>
              `;
      ...
      if (data['page'] < data['totalPages']) {
          ...
          html += `
              ...
              Load next ${data['perPage']} results <i class="bi bi-search"></i>
              </button>
        ...
        switch (cos) {
          ...
          case "https://w3id.org/jp-cos/UpperSecondary/2018":
            ...
            <button id="nhk4school-button-${cscode}-1" class="btn btn-outline-info btn-sm btn-nhk4school p-1"
              ...
              Search videos from "NHK for School" <i class="bi bi-search"></i>
            </button>
